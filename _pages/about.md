...
## Recent News
- <span style="color:green; font-style:italic; font-weight:bold;">Research</span>: My recent paper, *“Finite element-integrated neural network for inverse analysis of elastic and elastoplastic boundary value problems”* ([DOI: 10.1016/j.cma.2024.117695](DOI: 10.1016/j.cma.2024.117695)), was published in Computer Methods in Applied Mechanics and Engineering (JCR Ranking 6/181, Top 3%) in March 2025. This paper presents a novel framework combining finite element methods (FEM) with neural networks to solve inverse problems in elastoplasticity, significantly improving computational efficiency and accuracy.
- <span style="color:green; font-style:italic; font-weight:bold;">Research</span>: My paper, *“Finite element-integrated neural network framework for elastic and elastoplastic solids”* ([DOI: 10.1016/j.cma.2024.117474](DOI: 10.1016/j.cma.2024.117474)), was published in Computer Methods in Applied Mechanics and Engineering (JCR Ranking 6/181, Top 3%) in January 2025. This work introduces a hybrid FEM-neural network approach for modeling elastic and elastoplastic solids, leveraging advanced sampling and transfer learning strategies to enhance predictive performance and generalization capabilities.
