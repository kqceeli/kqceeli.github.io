...
<head>
    ...
    <style>
        ...
        body {
            ...
            background-color: #ffffff;         /* 白色背景，保持简洁 */
            color: #333333;                    /* 深灰色字体，易于阅读 */
            line-height: 1.6;                  /* 行距适中，增强可读性 */
            margin: 0;
            padding: 0;
        }
        ...
        th {
            background-color: #f9f9f9;         /* 表头浅灰色背景 */
...
<body>
    ...
    <div class="container">
        ...
        <ul>
            ...
            <li><span class="timeline">03/2024:</span> Hubei Provincial Science & Technology Progress Award, Hubei Provincial People's Government, China</li>
            ...
            <li><span class="timeline">10/2020:</span> Top 10 Academic Star, Wuhan University</li>
            <li><span class="timeline">12/2019:</span> YuGang & SongXiao Scholarship, Wuhan University</li>
            <li><span class="timeline">10/2019:</span> Second Prize, Graduate Academic Report Competition, 10th National Youth Conference on Geomechanics & Geotechnical Engineering</li>
            ...
            <li><span class="timeline">12/2018:</span> Excellent Student Cadre, Wuhan University</li>
            ...
            <li><span class="timeline">07/2016:</span> Top 10 Future Star Undergraduate, Ministry of Education of the People's Republic of China</li>
        </ul>
